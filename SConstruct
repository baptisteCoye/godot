...
if selected_platform in platform_list:
    ...
    if (not env["platform"] == "server"): # FIXME: detect GLES3
        env.Append(BUILDERS = { 'VULKAN_GLSL' : env.Builder(action=run_in_subprocess(vulkan_builder.build_vulkan_headers), suffix='glsl.gen.h', src_suffix='.glsl')})
